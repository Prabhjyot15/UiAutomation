...
//                 {
//                     // Print the UI tree
//                     var uiTree = slackWindow.ToTreeString(3);
...
//             var info = $"{indent}{element.ControlType.ToString()}: {element.Name}";
...
//             await Task.Delay(20000); // Increase this delay as needed
...
//             try
//             {
//                 info += $": {element.ControlType.ToString()}";
//             }
//             catch (FlaUI.Core.Exceptions.PropertyNotSupportedException)
//             {
//                 info += " (ControlType: Not Supported)";
//             }
...
//             catch (FlaUI.Core.Exceptions.PropertyNotSupportedException)
//             {
//                 info += ", Name: Not Supported";
//             }

//             // Skip AutomationId and ClassName if not supported
//             info += ", AutomationId: Not Supported, ClassName: Not Supported";
...
//             // Retrieve children elements and expand the tree
//             foreach (var child in element.FindAllChildren())
//             {
//                 childrenInfo += child.ToTreeString(maxDepth, currentDepth + 1);
//             }
...
//             if (childrenInfo == string.Empty && element.FindAllChildren().Length == 0)
//             {
//                 return $"{info}\n(No children)";
//             }
